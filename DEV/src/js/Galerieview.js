 ...
 */
// HIER SCHAUEN WIE ICH DIE ANWEISUNG UND DEN EVENTLISTENER AM BESTEN IN DIE KLASSE IMPLEMENTIEREN KANN
if (this.closeButton) {
...
if (this.prevButton) {
    this.prevButton.addEventListener('click', () => {
        this.currentIndex = (this.currentIndex - 1 + this.imgPath.length) % this.imgPath.length;
        showImage(this.imgPath, this.currentIndex);
    });
}
...
if (this.nextButton) {
    this.nextButton.addEventListener('click', () => {
        this.currentIndex = (this.currentIndex + 1) % this.imgPath.length;
        showImage(this.imgPath, this.currentIndex);
    });
}
